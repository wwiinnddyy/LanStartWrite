...
export type VideoShowSource = 'camera' | 'phone-webrtc'
export const VIDEO_SHOW_SOURCE_UI_STATE_KEY = 'videoShowSource'
export const VIDEO_SHOW_WEBRTC_SESSION_ID_UI_STATE_KEY = 'videoShowWebrtcSessionId'
export const VIDEO_SHOW_WEBRTC_STATUS_UI_STATE_KEY = 'videoShowWebrtcStatus'
